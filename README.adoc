...
a|
- {hosts-each-default-system}[`aarch64-darwin`]
- {hosts-each-default-system}[`aarch64-linux`]
- {hosts-each-default-system}[`x86_64-darwin`]
- {hosts-each-default-system}[`x86_64-linux`]
a| Uses all `modules`.
|===
