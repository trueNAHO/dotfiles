...
== Examples
:command-base: home-manager switch --flake {repository-flake-url}#
...
----
{command-base}aarch64-darwin-eachDefaultSystem
{command-base}aarch64-linux-eachDefaultSystem
{command-base}x86_64-darwin-eachDefaultSystem
{command-base}x86_64-linux-eachDefaultSystem
----
