...
:dotfiles-contributing-7: link:https://github.com/trueNAHO/dotfiles/blob/master/docs/contributing.adoc
:dotfiles-design-7: link:https://github.com/trueNAHO/dotfiles/blob/master/docs/design/main.adoc
:dotfiles: link:https://wiki.archlinux.org/title/Dotfiles
...
:license: link:https://github.com/trueNAHO/dotfiles/blob/master/LICENSE
:naho-dotfiles: link:https://github.com/trueNAHO/dotfiles
:naho-os: link:https://github.com/trueNAHO/os
